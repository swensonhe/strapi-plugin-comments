...
const routes: StrapiRoute[] = [
  ...
  },
  {
    ...
    config: {
      policies: [],
			middlewares : ["plugin::comments.attachIsLikeToComment"],
      description:
  ...
  },
  {
	...
	{
    method: "GET",
    path: "/:relation/likes/flat",
    handler: "client.findAllFlatWithLikes",
    config: {
      policies: [],
			middlewares : ["plugin::comments.attachIsLikeToComment"],
			description:
				"Find all comments with likes related to configured Collection / Single Type and return them in a flat structure for further processing",
    ...
    method: "GET",
    path: "/:relation/likes",
    handler: "client.findAllInHierarchyWithLikes",
    config: {
      policies: [],
			middlewares : ["plugin::comments.attachIsLikeToComment"],
			description: "Find all Hierarchy comments with likes related to configured Collection / Single Type and return them in a nested structure",
    },
  },
	{
    method: "DELETE",
    path: "/comments/:relation/comment/:commentId",
    handler: "client.deleteComment",
    config: {
			policies: [],
    },
  }
